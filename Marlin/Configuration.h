...
#define STRING_CONFIG_H_AUTHOR "(fex42, ender-3 bl-touch)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "MKS MINI E3 V1.2"
 ...
 */
#define NOZZLE_TO_PROBE_OFFSET { -47.2, 7.5, -1.39 }
