...
#define STRING_CONFIG_H_AUTHOR "(fex42, Ghost4S TMC2208 BLTouch)" // Who made the changes.
 ...
 */
#define NOZZLE_TO_PROBE_OFFSET { 38, -31, -0.82 }
...
#define Z_CLEARANCE_MULTI_PROBE     53// Z Clearance between multiple probes
